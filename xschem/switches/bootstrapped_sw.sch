...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 940 -240 1 0 {name=Ms
L=0.5
W=1
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 1080 -620 1 0 {name=Ms1
L=0.4
W=1
nf=1
mult=1
...
model=nfet_01v8_lvt
spiceprefix=X}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 1190 -620 1 0 {name=Ms2
L=0.4
W=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 660 -620 3 1 {name=M4
L=0.4
W=1
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 560 -310 0 1 {name=M1
L=0.4
W=1
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 430 -430 1 0 {name=M2
L=0.4
W=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 430 -620 1 0 {name=M3
L=0.4
W=1
nf=1
mult=1
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 540 -500 0 0 {name=Cbs[3:0] model=cap_mim_m3_1 W=5 L=5 MF=1 spiceprefix=X ic=0
}
